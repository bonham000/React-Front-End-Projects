...
var Root = function (_React$Component) {
  ...
  _createClass(Root, [{
    key: 'adjustRange',
    value: function adjustRange(event) {
...
var ResultsContainer = function (_React$Component3) {
  ...
  function ResultsContainer() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(ResultsContainer).apply(this, arguments));
  }

  _createClass(ResultsContainer, [{
    key: 'openLink',
    value: function openLink(value) {
      window.open(value);
    }
  }, {
    key: 'render',
